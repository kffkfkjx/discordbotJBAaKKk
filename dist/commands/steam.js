    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new discord_js_1.EmbedBuilder()
                ...
                .addFields({ name: 'Geliştirici', value: data.developers ? data.developers.join(', ') : 'Bilinmiyor', inline: true }, { name: 'Fiyat', value: priceText, inline: true }, { name: 'Çıkış Tarihi', value: data.release_date?.date || 'Bilinmiyor', inline: true })
