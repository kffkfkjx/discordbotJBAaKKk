...
exports.setBotFunctions = setBotFunctions;
exports.startDashboard = startDashboard;
const express_1 = __importDefault(require("express"));
let isBotRunning = true; // Bot starts running by default in index.ts
let _startBotFn = () => { };
let _stopBotFn = () => { };
let _statsFn = () => ({ ping: 0, uptime: 0, servers: 0, users: 0 });
function setBotFunctions(startFn, stopFn, statsFn) {
    _startBotFn = startFn;
    _stopBotFn = stopFn;
    _statsFn = statsFn;
}
function startDashboard(startBotFn, stopBotFn) {
